        ...
        <div id="content">
            <nav class="navbar navbar-default user">
                <div class="container-fluid">
                    <h2 class="nav navbar-nav navbar-right titulo">Gestión de Apadrinamientos</h2>
                </div>
            </nav>
            <div class="container-fluid">
                <div class="container mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a class="agregarEvento btn d-flex align-items-center">
                            <i class="fas fa-plus p-1"></i> GENERAR REPORTE
                        </a>

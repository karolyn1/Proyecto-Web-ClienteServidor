...
$result_animales = $conexion->query($sql_animales);
$total_animales = 0;
...
$result_animales_apadrinados = $conexion->query($sql_animales_apadrinados);
$total_apadrinados = 0;
...
$result_total_donaciones = $conexion->query($sql_total_donaciones);
$total_donaciones = 0;
